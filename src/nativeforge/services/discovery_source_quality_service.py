...
def build_discovery_source_quality(
    ...
    *,
    ...
    out["active_source_creation_execution_dry_run"] = (
        asceddrs_svc.build_discovery_read_only_active_source_creation_execution_dry_run_attachment()
    )
    ...
    out["active_source_creation_execution_plan"] = (
        asceplan_svc.build_discovery_read_only_active_source_creation_execution_plan_attachment()
    )
