...
SCHEMA_VERSION = "nf_campaign_block23_smoke_v1"
DEFAULT_OUT = Path("artifacts/campaign_block23_smoke")


def run_campaign_block23_smoke() -> dict[str, Any]:
    run_id = (
        f"nf_camp23_persist_gate_smoke_"
    ...
    pag = bridge.get("persistence_approval_gate") or {}
    if not pag:
        fails.append("bridge_missing_persistence_approval_gate")
    else:
        fails.extend(persistence_approval_demo_surface_invariant_failures(pag))
