"""NM-5: NM pilot honesty regression."""
...
SCHEMA_VERSION = "nf_nm_pilot_honesty_regression_v1"
...
def run_nm_pilot_honesty_regression(
    *,
    ...
    checks = {
        ...
        **{f"sc_{k}": v for k, v in sc["checks"].items()},
        "nm_pilot_fixtures_present": all(present.values()),
    }
    return _json_safe(
        {
            ...
            else "NM pilot fixtures missing — skip integration ACs",
        }
    )
