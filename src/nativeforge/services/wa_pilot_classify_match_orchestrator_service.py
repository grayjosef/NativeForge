"""WA-4: WA pilot classify+match — all federal tribes, grant_posture advisory only."""
...
SCHEMA_VERSION = "nf_wa_pilot_classify_match_orchestrator_v1"
...
def run_wa_pilot_classify_match_block(
    *,
    org_id: Any = None,
    ...
    profiles_raw = load_wa_tribal_profiles(require_files=require_fixtures)
    ...
    for fk in keys:
        profile = resolve_wa_pilot_profile(fk, require_files=require_fixtures)
