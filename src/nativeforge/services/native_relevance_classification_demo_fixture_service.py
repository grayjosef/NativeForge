"""Sprint 188: synthetic demo fixture corpus for native relevance classification."""
...
SCHEMA_VERSION = "nf_native_relevance_classification_demo_fixture_v1"
...
def load_demo_classification_fixtures() -> list[dict[str, Any]]:
