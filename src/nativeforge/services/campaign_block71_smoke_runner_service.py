...
SCHEMA_VERSION = "nf_campaign_block71_smoke_v1"
DEFAULT_OUT = Path("artifacts/campaign_block71_smoke")


def run_campaign_block71_smoke() -> dict[str, Any]:
    run_id = (
        f"nf_camp71_freshness_smoke_"
    ...
    if not bridge.get("source_freshness"):
        fails.append("bridge_missing_source_freshness")
