...
#
# `replay`, `evidence`, `ledger`, `attest`, `attested`, `proving`,
# `weakest`, `legacy_gap`, `evidence_status`, `audit_replay`,
# `enforcement` and `storage_allowed` were added by Gate 152.
#
# `digest_record`, `digest_persistence`, `persisted`, `payload_hash`,
# `hash_stable`, `archived`, `honesty`, `linkage`, `roundtrip`,
# `round_trip` and `cross_org_read` were added by Gate 151, opening the
# operational durability block.
#
# `reassessment`, `decision_delta`, `baseline`, `clarification`,
# `throughline`, `safe_claim`, `unsafe_claim`, `next_block`,
# `approvals_outstanding` and `lanes_moved` were added by Gate 150,
# closing the 146-150 block.
#
# `pilot`, `pilot_activation`, `prerequisite`, `bundled`, `bundle`,
# `separately_gated`, `would_unlock`, `activation_mechanism`,
# `rollback_owner` and `support_owner` were added by Gate 149.
#
# `data_class`, `data_boundary`, `write_guard`, `beta_scope`,
# `not_consent`, `inferred_consent`, `pre_consent`, `fixture_write`,
# `tenant_supplied` and `never_stored` were added by Gate 148.
#
# `verified_binding`, `approval_boundary`, `refusal_matrix`,
# `dry_run_decision`, `classification`, `authorized_real_org`,
# `qualified_principal` and `mutation_path` were added by Gate 147.
#
# `second_person`, `invite_binding`, `next_human_action`, `refused_shortcut`,
# `test_user_enrolment`, `bypass_flag`, `stage_order`, `checklist` and
# `readiness_passed` were added by Gate 146. Its module name carries `auth`, so
# the selection was not at risk here either - same reasoning as Gate 145's
# entry below.
#
# `beta_decision`, `decision_matrix`, `scope_decision`, `conflation`,
# `unsafe_claim`, `human_approval`, `technical_blocker`, `limited_go`, `no_go`,
# `go_branch`, `internal_demo`, `production_rollout`, `controlled_customer` and
# `capability_flag` were added by Gate 145. Its module name carries `readiness`
# so the selection was never actually at risk - but the whole point of this
# guard is that the cheap moment to widen the expression is the gate that lands
# the module, not the gate that trips over it.
#
...
GATE_K='order_independence or recognition_requirement_coverage_expansion or sprint348_nf15_closeout or fit_dimension or readiness or gate37 or audit_state or audit_refs or demo_payload or negative_intelligence or sc_customer_demo or notice_ingestion or notice_artifact or html_notice or pdf_notice or nofo or notice or amendment or eligibility_exclusion or excluded_by_evidence or funding_lane or south_carolina or sc_state or sc_source or sc_native or state_recognized or federally_recognized or grants_gov or federal or corpus or fixture or source or opportunity or discovery or stale or duplicate or native or capability or audit or invite or approval or backup or restore or storage or postgres or rls or membership or identity or oidc or auth or token or tenant or rbac or role or authority or claim or demo or deadline or normalization or freshness or awarded or pursuit or reporting or lifecycle or attachment or extraction or network or http or robots or chokepoint or user_agent or guard or payload or redaction or promotion or evidence or secret or store or migration or alembic or schema or repository or body_store or object_store or settings or credential or s3 or scheduler or schedule or circuit or breaker or monitor or check_run or job or queue or dry_run or idempotency or runtime or worker or broker or dependency or backend or persistent or systemd or loopback or lifespan or proof or install or attach or tenant or entitlement or allowability or fixture or recognition or digest or snapshot or suppression or nofo or bridge or shadow or classification or attestation or regeneration or drift or honest or empty or unknown or obligation or calendar or binding or cross_tenant or canonicalization or rls or principal or binder or verified_org or resolution or membership or profile_id or binding_store or provenance or persistence_capability or spine or activation or role_mapping or session_policy or auth_route or enforcement or pkce or redirect_flow or session_format or state_store or session or replay or signing_key or authorization_url or redirect_state or live_redirect or binding_repository or verified_binding or workflow or preflight or provider_readiness or runbook or activation_blocker or dev_header or org_context or replacement or tenant_profile or operating_state or recognition or awarded_grant or award_status or active_obligation or projected_burden or lineage or archive or award_requirement or requirement_source or due_date or proof or submission or document_reference or proof_event or audit_trail or supersede or retention or event_type or event_status or document_store or object_store or object_key or legal_hold or customer_visible or metadata or callback_url or callback_route or public_origin or derived_callback or config_schema or operating_shell or truth_label or demo_live or auth_settings or secret_safe or api_runtime or discovery or well_known or endpoint or google or provider_metadata or conventional or reliability or tunnel or verifier or talk_track or hermetic or restart_policy or live_stack or pkce or verifier_encryption or token_exchange or state_store or minting or one_time or replay_refused or bootstrap or org_binding or session_activation or demo_org or reconciliation or allowlist or current_user or self_approval or binding_evidence or is_demo or login_live or jwks or validation_event or role_mapping or owner_activation or activation_decision or dev_header or exposure or kill_plan or preview_proxy or tunnel_config or converted or session_org or org_context or forged_header or unauthenticated or demo_only or real_only or membership_row or regressed or shutdown_readiness or invite or invite_binding or provenance or self_dealt or accepted_invite or customer_auth_approval or dead_chain or chains_are_gone or activation_decision or invite_activation or accepter or invited_identity or seat_cap or expired or already_accepted or verifier or execution_guide or operator_invite or subsumes or verified_operational or activation_boundary or approval_object or authorized_list or hermetic_real_org or is_demo_derived or production_write or ambiguous or duplicate_binding or partition or round_trip or persistence_live or accountable or lane or cross_org or fixture_labelled or scaffold or read_back or controlled_dev or archive or awarded_operational or post_award or route_live or supersede or due_date or unresolved or metadata_only or body_storage or relabel or session_wired or immutable or tenant_digest or source_watchlist or watchlist or watching or monitoring_live or preview_only or cadence or weekly or daily or suppression_lift or caveat or registry_source or digest_item or recommended_action or object_storage or object_store or object_key or body_storage or document_storage or adapter or hermetic_fake or preflight_state or unsafe_key or traversal or credential_names or metadata_only or key_namespace or email_delivery or delivery_intent or dry_run or recipient or fingerprint or render or subject_line or send_activation or provider_preflight or mailbox or period_key or unsubscribe or consent or source_monitoring or allowlist or terms_blocked or human_review or api_key or collector_config or chokepoint or no_live_call or activation_approved or registry_row or attribution_verbatim or preflight_ready or cockpit or beta_onboarding or readiness_summary or lane or next_safe_action or blocker_matrix or capability_matrix or forbidden_lane or operational_lane or surface or beta_decision or decision_matrix or scope_decision or conflation or unsafe_claim or human_approval or technical_blocker or limited_go or no_go or go_branch or internal_demo or production_rollout or controlled_customer or capability_flag or second_person or invite_binding or next_human_action or refused_shortcut or test_user_enrolment or bypass_flag or stage_order or checklist or readiness_passed or verified_binding or approval_boundary or refusal_matrix or dry_run_decision or classification or authorized_real_org or qualified_principal or mutation_path or data_class or data_boundary or write_guard or beta_scope or not_consent or inferred_consent or pre_consent or fixture_write or tenant_supplied or never_stored or pilot or pilot_activation or prerequisite or bundled or bundle or separately_gated or would_unlock or activation_mechanism or rollback_owner or support_owner or reassessment or decision_delta or baseline or clarification or throughline or safe_claim or unsafe_claim or next_block or approvals_outstanding or lanes_moved or digest_record or digest_persistence or persisted or payload_hash or hash_stable or archived or honesty or linkage or roundtrip or round_trip or cross_org_read or replay or evidence or ledger or attest or attested or proving or weakest or legacy_gap or evidence_status or audit_replay or enforcement or storage_allowed or backup_manifest or backup_restore or operational_backup or restore_target or isolated_target or restore_refusal or restore_verification or payload_sha or hash_per_table or fixture_only or review_hint or classified_by_meaning or legacy_gaps_preserved or production_backup or export_summary or fidelity or operational_health or runbook_health or health_model or verifier_registry or failure_mode or stale_stamp or stale_code or migration_drift or next_safe_action or awaiting_human or expected_result or production_monitoring or observability or component_status or shell_execution or durability_reassessment or lane_delta or next_activation or wrapper or unlock or closeout or safe_claim or unsafe_claim or conflation or created_not_flipped or limited_go or no_go or engineering_advancable or blocker_kind or scheduler_runtime or scheduler_health or collection_job or next_run or cadence or due_but_blocked or empty_allowlist or refusal_path or permitting_branch or injected_clock or terms_blocked or human_review_blocked or executable_job or worker_runtime or job_lease or retry_policy or claim or duplicate_claim or expired_lease or reclaim or backoff or attempt_budget or failure_class or transient or worker_health or restart_recovery or truncated_batch or handler or job_store or collection_job_store or durable_row or enqueue or idempotent or deduplicated or state_machine or transition or illegal_transition or legal_transition or execution_proof or retry_wait or archived_at or backlog or perpetual_slot or survives_restart or preserved or countable or job_identity or vocabulary or normalized or lease_boundary or store_loaded or orchestration or orchestrator or periodic or trigger or cadence or slot or slot_index or cycle_id or duplicate_trigger or suppressed or missed_window or catchup or recovery or recovered or reclaim or reclaimable or expired_owner or stale_owner or single_active or concurrent or ownership or crashed or unfinished or wake or restart_idempotent or bounded or one_shot or systemd_unit or raw_payload or payload or attempt_identity or attempt_number or body_bytes or exact_bytes or round_trip or hash_verified or tamper or tampered or replay or replayable or provenance or allowlist or header or credential_header or metadata_filter or oversize or size_limit or archive or archived or retention or object_store or fingerprint or base64 or collector_version or landing_zone or spine or execution_envelope or collector_execution or hermetic_execution or hermetic_transport or transport_boundary or transport_kind or dispatchable or injected_transport or live_transport or execution_attempt or execution_status or execution_policy or request_builder or caller_supplied_url or ssrf or url_parameter or retry_after or retry_classification or transient_worker or permanent_worker or malformed_body or unregistered or connection_failed or timeout or rate_limited or server_error or not_found or usable or proves_a_source_responded or proves_the_envelope_works or hermetic_completion or job_completion or evidenced or falsifiable or injected_import or renamed_module or substring or ast or refusal_condition or fires_alone or smoke_route or savepoint or rolled_back or knowing_is_not_approving or known_source or authorization or authorization_boundary or recorded_fact or fact_model or fact_resolver or fact_status or derivation_strength or recorded_decision or decision_kind or terms_decision or human_review_decision or activation_decision or attribution_decision or runtime_decision or robots_decision or missing_fact or needs_review or stale or unsigned or signer or attribution_required not_an_approval or authorizes_nothing or allowlist_projection or allowlisted or projection or fixture_registry or fixture_prefix or synthetic_fixture or permittable or undecided or reachable or forged or fabricated or bypass or withheld or opted_in or live_fetch or activation_packet or activation_contract or runtime_readiness or lane or lanes_ready or background_worker or guard_input or guard_allowed or pure_function'
...
CRITICAL=(
  ...
  "tests/test_gate132_first_dev_org_binding_session_activation.py::test_the_organization_row_decides_not_the_settings_allowlist"
  "tests/test_gate132_first_dev_org_binding_session_activation.py::test_the_bootstrap_refuses_a_non_demo_organization"
  "tests/test_gate132_first_dev_org_binding_session_activation.py::test_self_approval_is_permitted_once_and_then_refused"
  "tests/test_gate132_first_dev_org_binding_session_activation.py::test_a_cookie_claiming_another_organization_authorizes_nothing"
  "tests/test_gate132_first_dev_org_binding_session_activation.py::test_current_user_is_401_without_a_session"
  "tests/test_gate133_login_live_dev_header_kill.py::test_the_validation_event_stores_no_token_subject_or_claim"
  "tests/test_gate133_login_live_dev_header_kill.py::test_role_mapping_comes_from_the_membership_row"
  "tests/test_gate133_login_live_dev_header_kill.py::test_the_owner_decision_can_never_approve_customer_auth"
  "tests/test_gate133_login_live_dev_header_kill.py::test_login_live_becomes_true_when_the_measured_facts_pass"
  "tests/test_gate133_login_live_dev_header_kill.py::test_the_preview_proxy_is_still_the_hop_the_containment_detector_misses"
  "tests/test_gate134_dev_header_kill.py::test_no_route_consumes_the_dev_header"
  "tests/test_gate134_dev_header_kill.py::test_a_forged_header_cannot_override_the_session"
  "tests/test_gate134_dev_header_kill.py::test_the_header_alone_opens_nothing"
  "tests/test_gate134_dev_header_kill.py::test_a_session_without_a_membership_is_refused"
  "tests/test_gate134_dev_header_kill.py::test_customer_auth_live_stays_false_with_the_header_gone"
  "tests/test_gate135_customer_auth_activation.py::test_the_dead_chains_are_gone"
  "tests/test_gate135_customer_auth_activation.py::test_nothing_declares_the_dev_header_any_more"
  "tests/test_gate135_customer_auth_activation.py::test_the_owner_cannot_accept_their_own_invite"
  "tests/test_gate135_customer_auth_activation.py::test_customer_auth_live_becomes_true_only_with_all_of_it"
  "tests/test_gate135_customer_auth_activation.py::test_customer_auth_live_is_false_without_the_invite"
  "tests/test_gate136_invite_activation_readiness.py::test_a_completed_invite_plus_a_membership_satisfies_the_gate"
  "tests/test_gate136_invite_activation_readiness.py::test_an_uninvited_identity_cannot_accept"
  "tests/test_gate136_invite_activation_readiness.py::test_a_membership_that_shares_an_identity_but_not_the_invite_does_not_count"
  "tests/test_gate136_invite_activation_readiness.py::test_the_verifier_reports_blocked_with_the_exact_blocker"
  "tests/test_gate136_invite_activation_readiness.py::test_the_verifier_can_report_pass"
  "tests/test_gate137_verified_operational_binding_path.py::test_the_demo_refusal_is_derived_from_the_row_not_from_the_caller"
  "tests/test_gate137_verified_operational_binding_path.py::test_the_real_org_is_refused_by_name_even_with_an_approval"
  "tests/test_gate137_verified_operational_binding_path.py::test_a_hermetic_real_org_binding_can_be_written_with_approval"
  "tests/test_gate137_verified_operational_binding_path.py::test_the_runtime_real_org_is_never_written_to"
  "tests/test_gate137_verified_operational_binding_path.py::test_a_second_verified_binding_with_other_labels_is_refused_too"
  "tests/test_gate138_customer_persistence_activation.py::test_persistence_live_is_measured_from_a_real_round_trip"
  "tests/test_gate138_customer_persistence_activation.py::test_the_written_row_is_read_back_by_id_not_merely_counted"
  "tests/test_gate138_customer_persistence_activation.py::test_scaffolding_rows_are_cleaned_up_too"
  "tests/test_gate138_customer_persistence_activation.py::test_the_real_org_is_refused"
  "tests/test_gate138_customer_persistence_activation.py::test_customer_auth_live_is_not_silently_made_true"
  "tests/test_gate139_awarded_grants_operational.py::test_the_end_to_end_smoke_proves_every_lane"
  "tests/test_gate139_awarded_grants_operational.py::test_a_due_date_without_a_status_is_refused"
  "tests/test_gate139_awarded_grants_operational.py::test_an_unsupported_requirement_stays_unresolved"
  "tests/test_gate139_awarded_grants_operational.py::test_the_object_store_is_never_contacted"
  "tests/test_gate139_awarded_grants_operational.py::test_production_awarded_tracking_stays_false"
  "tests/test_gate140_tenant_digest_operational.py::test_watching_is_not_monitoring"
  "tests/test_gate140_tenant_digest_operational.py::test_a_preview_is_not_a_delivery"
  "tests/test_gate140_tenant_digest_operational.py::test_a_suppression_carries_a_real_audit_event"
  "tests/test_gate140_tenant_digest_operational.py::test_daily_is_refused_until_the_profile_enables_it"
  "tests/test_gate140_tenant_digest_operational.py::test_monitoring_and_email_are_not_required_for_a_preview"
  "tests/test_gate141_document_storage_readiness.py::test_the_body_route_refuses_with_the_missing_key_names"
  "tests/test_gate141_document_storage_readiness.py::test_a_hermetic_fake_never_configures_the_store"
  "tests/test_gate141_document_storage_readiness.py::test_the_external_adapter_is_inert_by_default"
  "tests/test_gate141_document_storage_readiness.py::test_metadata_does_not_require_the_object_store"
  "tests/test_gate141_document_storage_readiness.py::test_object_store_configured_is_measured_not_asserted"
  "tests/test_gate142_email_delivery_readiness.py::test_no_delivery_module_imports_a_mail_library"
  "tests/test_gate142_email_delivery_readiness.py::test_a_dry_run_never_activates_delivery"
  "tests/test_gate142_email_delivery_readiness.py::test_no_address_appears_in_a_validation_result"
  "tests/test_gate142_email_delivery_readiness.py::test_the_database_refuses_a_row_that_claims_a_send"
  "tests/test_gate142_email_delivery_readiness.py::test_readiness_is_true_and_delivery_is_false"
  "tests/test_gate143_source_monitoring_preflight.py::test_no_source_in_the_shipped_registry_is_monitorable"
  "tests/test_gate143_source_monitoring_preflight.py::test_an_approval_never_clears_a_terms_blocker"
  "tests/test_gate143_source_monitoring_preflight.py::test_direct_http_outside_the_chokepoint_is_detected"
  "tests/test_gate143_source_monitoring_preflight.py::test_source_monitoring_live_comes_from_the_scheduler_and_stays_false"
  "tests/test_gate143_source_monitoring_preflight.py::test_sam_gov_stays_blocked_even_with_an_activation_approval"
  "tests/test_gate144_beta_onboarding_cockpit.py::test_a_summary_with_no_evidence_claims_nothing_operational"
  "tests/test_gate144_beta_onboarding_cockpit.py::test_the_invariants_catch_a_forged_forbidden_lane"
  "tests/test_gate144_beta_onboarding_cockpit.py::test_every_false_lane_on_the_route_names_a_blocker"
  "tests/test_gate144_beta_onboarding_cockpit.py::test_the_route_does_not_grade_its_own_homework"
  "tests/test_gate144_beta_onboarding_cockpit.py::test_the_existing_surfaces_still_dispatch"
  "tests/test_gate145_controlled_beta_readiness.py::test_the_customer_beta_go_branch_is_reachable"
  "tests/test_gate145_controlled_beta_readiness.py::test_the_invariants_catch_an_unconditional_customer_go"
  "tests/test_gate145_controlled_beta_readiness.py::test_the_invariants_catch_a_forged_production_go"
  "tests/test_gate145_controlled_beta_readiness.py::test_the_capability_flags_are_measured_not_supplied"
  "tests/test_gate145_controlled_beta_readiness.py::test_readiness_is_not_treated_as_capability"
  "tests/test_gate146_customer_auth_second_person_event.py::test_the_complete_state_reaches_customer_auth_live"
  "tests/test_gate146_customer_auth_second_person_event.py::test_customer_auth_live_is_not_a_parameter"
  "tests/test_gate146_customer_auth_second_person_event.py::test_the_invariants_catch_a_forged_customer_auth_live"
  "tests/test_gate146_customer_auth_second_person_event.py::test_a_membership_written_directly_does_not_satisfy_the_gate"
  "tests/test_gate146_customer_auth_second_person_event.py::test_the_accept_script_has_no_bypass_flag"
  "tests/test_gate147_verified_binding_approval_boundary.py::test_the_demo_organization_stays_refused_with_everything_granted"
  "tests/test_gate147_verified_binding_approval_boundary.py::test_the_real_organization_cannot_be_smuggled_into_the_authorized_set"
  "tests/test_gate147_verified_binding_approval_boundary.py::test_the_permitted_branch_is_reachable"
  "tests/test_gate147_verified_binding_approval_boundary.py::test_a_caller_cannot_declare_the_demo_org_real"
  "tests/test_gate147_verified_binding_approval_boundary.py::test_the_dry_run_writes_nothing_on_every_branch"
  "tests/test_gate148_customer_data_boundary.py::test_demo_fixture_writes_are_still_allowed"
  "tests/test_gate148_customer_data_boundary.py::test_an_unknown_data_class_is_refused"
  "tests/test_gate148_customer_data_boundary.py::test_login_membership_and_invite_are_each_named_as_not_consent"
  "tests/test_gate148_customer_data_boundary.py::test_the_permitted_branch_is_reachable_and_writes_nothing"
  "tests/test_gate148_customer_data_boundary.py::test_the_guard_never_writes_on_any_branch"
  "tests/test_gate149_controlled_customer_pilot_activation.py::test_the_boundary_activates_nothing_on_any_branch"
  "tests/test_gate149_controlled_customer_pilot_activation.py::test_bundling_production_is_refused_by_its_own_name"
  "tests/test_gate149_controlled_customer_pilot_activation.py::test_the_permitted_branch_is_reachable"
  "tests/test_gate149_controlled_customer_pilot_activation.py::test_no_route_anywhere_sets_the_pilot_true"
  "tests/test_gate149_controlled_customer_pilot_activation.py::test_no_migration_creates_a_pilot_approval_table"
  "tests/test_gate150_customer_beta_reassessment.py::test_a_customer_go_without_approvals_is_refused"
  "tests/test_gate150_customer_beta_reassessment.py::test_the_honest_customer_go_branch_is_reachable"
  "tests/test_gate150_customer_beta_reassessment.py::test_no_decision_changed"
  "tests/test_gate150_customer_beta_reassessment.py::test_production_remains_no_go_whatever_is_supplied"
  "tests/test_gate150_customer_beta_reassessment.py::test_readiness_passing_alongside_a_false_capability_is_correct"
  "tests/test_gate151_tenant_digest_persistence.py::test_a_digest_persists_and_reads_back"
  "tests/test_gate151_tenant_digest_persistence.py::test_the_payload_hash_is_stable"
  "tests/test_gate151_tenant_digest_persistence.py::test_unknown_and_the_caveats_survive_the_round_trip"
  "tests/test_gate151_tenant_digest_persistence.py::test_an_archived_digest_stays_readable_by_id"
  "tests/test_gate151_tenant_digest_persistence.py::test_the_table_has_no_recipient_or_body_column"
  "tests/test_gate152_audit_replay_evidence_ledger.py::test_an_intent_naming_an_unpersisted_digest_is_refused_end_to_end"
  "tests/test_gate152_audit_replay_evidence_ledger.py::test_the_refusal_is_not_caused_by_the_fingerprint"
  "tests/test_gate152_audit_replay_evidence_ledger.py::test_storage_allowed_agrees_with_the_blocker_list"
  "tests/test_gate152_audit_replay_evidence_ledger.py::test_a_missing_digest_is_not_fabricated"
  "tests/test_gate152_audit_replay_evidence_ledger.py::test_a_backfill_fails_the_lane_rather_than_passing_it"
  "tests/test_gate153_backup_restore_readiness.py::test_a_real_round_trip_restores_every_row_and_reverifies"
  "tests/test_gate153_backup_restore_readiness.py::test_a_restore_whose_target_is_the_source_is_refused"
  "tests/test_gate153_backup_restore_readiness.py::test_a_restore_into_a_target_that_is_not_isolated_is_refused"
  "tests/test_gate153_backup_restore_readiness.py::test_a_fallen_legacy_gap_count_blocks_the_lane"
  "tests/test_gate153_backup_restore_readiness.py::test_org_memberships_is_excluded_for_identity_not_for_the_word_state"
  "tests/test_gate154_operational_health_runbook.py::test_a_healthy_deployment_is_ready"
  "tests/test_gate154_operational_health_runbook.py::test_a_lane_false_by_design_is_not_a_health_blocker[customer_auth_live]"
  "tests/test_gate154_operational_health_runbook.py::test_an_unexpected_result_closes_the_lane"
  "tests/test_gate154_operational_health_runbook.py::test_the_two_backup_verifiers_do_not_share_a_lane"
  "tests/test_gate154_operational_health_runbook.py::test_an_approval_gated_action_never_carries_a_command"
  "tests/test_gate155_operational_durability_reassessment.py::test_no_lane_that_was_false_became_true"
  "tests/test_gate155_operational_durability_reassessment.py::test_the_customer_beta_decision_is_unchanged"
  "tests/test_gate155_operational_durability_reassessment.py::test_the_production_decision_is_unchanged"
  "tests/test_gate155_operational_durability_reassessment.py::test_recommending_a_wrapper_block_is_refused"
  "tests/test_gate155_operational_durability_reassessment.py::test_the_customer_branch_is_reachable"
  "tests/test_gate156_source_scheduler_runtime.py::test_an_empty_allowlist_yields_zero_executable_jobs"
  "tests/test_gate156_source_scheduler_runtime.py::test_runtime_ready_does_not_mean_source_monitoring_live"
  "tests/test_gate156_source_scheduler_runtime.py::test_zero_executable_comes_from_counting_not_a_guard"
  "tests/test_gate156_source_scheduler_runtime.py::test_the_permitting_branch_is_reachable"
  "tests/test_gate156_source_scheduler_runtime.py::test_absence_is_never_permission"
  "tests/test_gate157_source_worker_runtime.py::test_a_duplicate_claim_is_refused"
  "tests/test_gate157_source_worker_runtime.py::test_an_expired_lease_can_be_reclaimed"
  "tests/test_gate157_source_worker_runtime.py::test_a_non_transient_failure_is_never_retried[terms_blocked]"
  "tests/test_gate157_source_worker_runtime.py::test_a_transient_failure_is_retried"
  "tests/test_gate157_source_worker_runtime.py::test_worker_ready_does_not_mean_source_monitoring_live"
  "tests/test_gate158_collection_job_store.py::test_repeated_cycles_do_not_grow_the_store"
  "tests/test_gate158_collection_job_store.py::test_the_database_refuses_a_completed_row_with_the_repository_bypassed"
  "tests/test_gate158_collection_job_store.py::test_the_worker_preserves_the_blockers_the_scheduler_recorded"
  "tests/test_gate158_collection_job_store.py::test_the_identity_reproduces_the_id_the_job_model_already_carries"
  "tests/test_gate158_collection_job_store.py::test_a_lane_with_no_restart_evidence_is_red_and_says_so"
  "tests/test_gate159_source_orchestration_runtime.py::test_a_crashed_slot_reads_as_unfinished_not_served"
  "tests/test_gate159_source_orchestration_runtime.py::test_the_reclaim_path_is_reachable_through_the_runtime"
  "tests/test_gate159_source_orchestration_runtime.py::test_the_same_slot_twice_produces_one_effect"
  "tests/test_gate159_source_orchestration_runtime.py::test_catchup_is_bounded_is_falsifiable[9-6-3-True-False]"
  "tests/test_gate159_source_orchestration_runtime.py::test_recovery_invents_no_work"
  "tests/test_gate160_source_raw_payload_persistence.py::test_the_exact_bytes_round_trip_including_non_utf8"
  "tests/test_gate160_source_raw_payload_persistence.py::test_a_safe_header_SURVIVES"
  "tests/test_gate160_source_raw_payload_persistence.py::test_a_tampered_body_fails_replay_and_returns_no_bytes"
  "tests/test_gate160_source_raw_payload_persistence.py::test_the_same_attempt_with_different_bytes_is_refused"
  "tests/test_gate160_source_raw_payload_persistence.py::test_replay_resolves_provenance_by_looking"
  "tests/test_gate161_source_collector_execution_envelope.py::test_the_exact_response_bytes_are_hashed_before_any_decoding"
  "tests/test_gate161_source_collector_execution_envelope.py::test_live_is_refused_four_times_independently"
  "tests/test_gate161_source_collector_execution_envelope.py::test_each_hermetic_refusal_condition_fires_alone"
  "tests/test_gate161_source_collector_execution_envelope.py::test_the_chokepoint_scan_fails_on_an_injected_import"
  "tests/test_gate161_source_collector_execution_envelope.py::test_a_404_is_evidenced_and_completes_nothing"
  "tests/test_gate162_source_authorization_boundary.py::test_the_resolver_signature_cannot_assert_a_fact"
  "tests/test_gate162_source_authorization_boundary.py::test_a_fully_recorded_synthetic_fact_set_reaches_approved"
  "tests/test_gate162_source_authorization_boundary.py::test_the_synthetic_approved_branch_still_cannot_use_a_live_transport"
  "tests/test_gate162_source_authorization_boundary.py::test_forged_guard_booleans_cannot_change_an_authorization"
  "tests/test_gate162_source_authorization_boundary.py::test_no_column_anywhere_stores_an_allowlist_boolean"
)
