"""Sprint 103: separate runtime implementation readiness packet from Sprint 102 final approval packet (stateless, no DB)."""
...
from nativeforge.services.active_source_activation_separate_runtime_implementation_final_approval_packet_service import (
    EXPLICIT_SPRINT102_OUTPUT_GUARD_KEY as SPRINT102_EXPLICIT_GUARD,
)
from nativeforge.services.active_source_activation_separate_runtime_implementation_final_approval_packet_service import (
    NEXT_GATE_SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_PACKET as SPRINT102_EXPECTED_NEXT_GATE,
)
from nativeforge.services.active_source_activation_separate_runtime_implementation_final_approval_packet_service import (
...
from nativeforge.services.active_source_activation_separate_runtime_implementation_readiness_packet_service import (
    ...
    NEXT_GATE_SEPARATE_RUNTIME_IMPLEMENTATION_RELEASE_PACKET,
    ...
    sprint_103_readiness_packet_blockers_for_tests,
)
...
SERVICE_PATH = (
    ...
    / "nativeforge"
    / "services"
    / "active_source_activation_separate_runtime_implementation_readiness_packet_service.py"
)
...
def _valid_sprint102_separate_runtime_implementation_final_approval_packet() -> dict:
    ...
    return build_active_source_activation_separate_runtime_implementation_final_approval_packet(
        separate_runtime_implementation_plan_decision_packet_artifact=p101,
    )


def _build(pkt: dict | None) -> dict:
    return build_active_source_activation_separate_runtime_implementation_readiness_packet(
        separate_runtime_implementation_final_approval_packet_artifact=pkt,
    )
...
def test_happy_path_ready_separate_runtime_implementation_readiness_packet() -> None:
    p102 = _valid_sprint102_separate_runtime_implementation_final_approval_packet()
    out = _build(p102)
    assert out["separate_runtime_implementation_readiness_status"] == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_READY_STATUS
    assert out["artifact_type"] == ARTIFACT_TYPE
    assert out["artifact_version"] == 1
    assert out["version"] == "v1"
    assert out["separate_runtime_implementation_readiness_ready"] is True
    assert out["separate_runtime_implementation_readiness_only"] is True
    assert out["runtime_implementation_release_required"] is True
    assert out["separate_runtime_implementation_readiness_blockers"] == []
    assert out["next_gate_required"] == NEXT_GATE_SEPARATE_RUNTIME_IMPLEMENTATION_RELEASE_PACKET


def test_blocked_when_input_not_dict() -> None:
    out = _build(None)  # type: ignore[arg-type]
    assert out["separate_runtime_implementation_readiness_status"] == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    assert out["separate_runtime_implementation_readiness_ready"] is False
    assert (
...
def test_artifact_type_mismatch_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["artifact_type"] = "wrong"
    out = _build(p102)
    assert out["separate_runtime_implementation_readiness_status"] == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    assert (
        "sprint_102_separate_runtime_implementation_final_approval_packet_artifact_type_mismatch"
        in out["separate_runtime_implementation_readiness_blockers"]
    )


def test_artifact_version_mismatch_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["artifact_version"] = 2
    out = _build(p102)
    assert out["separate_runtime_implementation_readiness_status"] == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    assert (
        "sprint_102_separate_runtime_implementation_final_approval_packet_artifact_version_invalid"
        in out["separate_runtime_implementation_readiness_blockers"]
    )
...
def test_missing_preview_only_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    del p102["preview_only"]
    assert (
        _build(p102)["separate_runtime_implementation_readiness_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    )
...
def test_separate_runtime_implementation_final_approval_only_false_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["separate_runtime_implementation_final_approval_only"] = False
    out = _build(p102)
    assert out["separate_runtime_implementation_readiness_status"] == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    assert (
        "sprint_102_separate_runtime_implementation_final_approval_only_guardrail_missing_or_false"
        in out["separate_runtime_implementation_readiness_blockers"]
    )


def test_runtime_implementation_readiness_required_false_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["runtime_implementation_readiness_required"] = False
    out = _build(p102)
    assert out["separate_runtime_implementation_readiness_status"] == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    assert (
        "sprint_102_runtime_implementation_readiness_required_guardrail_missing_or_false"
        in out["separate_runtime_implementation_readiness_blockers"]
    )
...
def test_source_activation_authorized_true_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["source_activation_authorized"] = True
    assert (
        "sprint_102_source_activation_authorized_not_false"
        in _build(p102)["separate_runtime_implementation_readiness_blockers"]
    )


def test_source_activation_executed_true_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["source_activation_executed"] = True
    assert (
        "sprint_102_source_activation_executed_not_false"
        in _build(p102)["separate_runtime_implementation_readiness_blockers"]
    )
...
def test_source_activation_completed_true_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["source_activation_completed"] = True
    assert (
        "sprint_102_source_activation_completed_not_false"
        in _build(p102)["separate_runtime_implementation_readiness_blockers"]
    )
...
def test_source_activation_readiness_granted_true_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["source_activation_readiness_granted"] = True
    assert (
        "sprint_102_source_activation_readiness_granted_not_false"
        in _build(p102)["separate_runtime_implementation_readiness_blockers"]
    )


def test_final_approval_status_not_approved_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["separate_runtime_implementation_final_approval_status"] = SEPARATE_RUNTIME_IMPLEMENTATION_FINAL_APPROVAL_BLOCKED_STATUS
    out = _build(p102)
    assert out["separate_runtime_implementation_readiness_status"] == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    assert any(
        "sprint_102_separate_runtime_implementation_final_approval_status_not_approved" in x
        for x in out["separate_runtime_implementation_readiness_blockers"]
    )


def test_separate_runtime_implementation_final_approval_ready_false_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["separate_runtime_implementation_final_approval_ready"] = False
    assert (
        "sprint_102_separate_runtime_implementation_final_approval_ready_not_true"
        in _build(p102)["separate_runtime_implementation_readiness_blockers"]
    )
...
def test_next_gate_required_mismatch_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["next_gate_required"] = "wrong_gate"
    out = _build(p102)
    assert out["separate_runtime_implementation_readiness_status"] == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    assert any(
        "sprint_102_next_gate_required_mismatch" in x
        for x in out["separate_runtime_implementation_readiness_blockers"]
    )


def test_missing_runtime_final_approval_scope_summary_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    del p102["runtime_final_approval_scope_summary"]
    assert (
        _build(p102)["separate_runtime_implementation_readiness_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    )
...
def test_missing_runtime_final_approval_boundary_summary_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    del p102["runtime_final_approval_boundary_summary"]
    assert (
        _build(p102)["separate_runtime_implementation_readiness_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    )
...
def test_missing_runtime_final_approval_evidence_summary_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    del p102["runtime_final_approval_evidence_summary"]
    assert (
        _build(p102)["separate_runtime_implementation_readiness_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    )
...
def test_missing_runtime_final_approval_non_runtime_summary_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    del p102["runtime_final_approval_non_runtime_summary"]
    assert (
        _build(p102)["separate_runtime_implementation_readiness_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    )
...
def test_missing_separate_runtime_implementation_readiness_requirements_summary_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    del p102["separate_runtime_implementation_readiness_requirements_summary"]
    assert (
        _build(p102)["separate_runtime_implementation_readiness_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    )
...
def test_missing_prohibited_runtime_actions_summary_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    del p102["prohibited_runtime_actions_summary"]
    assert (
        _build(p102)["separate_runtime_implementation_readiness_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    )
...
def test_missing_sprint102_proof_dict_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    del p102[SPRINT102_PROOF_KEY]
    out = _build(p102)
    assert (
        "sprint_102_separate_runtime_implementation_final_approval_packet_proof_missing_or_invalid"
        in out["separate_runtime_implementation_readiness_blockers"]
    )


def test_missing_separate_runtime_implementation_plan_decision_summary_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    del p102["separate_runtime_implementation_plan_decision_summary"]
    assert (
        "sprint_102_separate_runtime_implementation_plan_decision_summary_missing_or_invalid"
        in _build(p102)["separate_runtime_implementation_readiness_blockers"]
    )
...
def test_actual_nonzero_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["actual_command_execution_count"] = 1
    out = _build(p102)
    assert any(
...
def test_may_flag_true_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["may_activate_sources"] = True
    out = _build(p102)
    assert any(
...
def test_explicit_sprint102_guardrail_missing_runtime_implementation_readiness_required_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102[SPRINT102_EXPLICIT_GUARD] = (
        "preview_only_no_execution_no_activation_no_runnable_plan_"
        "separate_runtime_implementation_final_approval_only_"
    ...
    out = _build(p102)
    assert any(
        "sprint_102_explicit_guardrail_missing_runtime_implementation_readiness_required_assertion" in x
        for x in out["separate_runtime_implementation_readiness_blockers"]
    )
...
def test_forbidden_nested_string_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["unsafe_nested_note"] = "curl http://example.invalid/foo"
    assert (
        _build(p102)["separate_runtime_implementation_readiness_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    )
...
def test_forbidden_source_activation_complete_language_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["unsafe_nested_note"] = "source activation complete narrative"
    assert (
        _build(p102)["separate_runtime_implementation_readiness_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    )
...
def test_output_always_preview_no_execution_no_activation_no_runnable() -> None:
    for pkt in (None, _valid_sprint102_separate_runtime_implementation_final_approval_packet()):
...
def test_output_always_source_activation_flags_false() -> None:
    out = _build(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
...
def test_output_contains_sprint103_proof_structure() -> None:
    out = _build(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    proof = out["sprint_103_separate_runtime_implementation_readiness_packet_proof"]
    assert isinstance(proof, dict)
    assert proof["sprint_103_separate_runtime_implementation_readiness_packet_is_stateless"] is True
    assert proof["sprint_103_separate_runtime_implementation_readiness_packet_does_not_activate_sources"] is True
    assert (
        proof["sprint_103_separate_runtime_implementation_readiness_packet_does_not_complete_source_activation"]
        is True
    )
...
def test_deterministic_across_repeated_calls() -> None:
    p102 = _valid_sprint102_separate_runtime_implementation_final_approval_packet()
    assert _build(p102) == _build(p102)


def test_input_is_not_mutated() -> None:
    p102 = _valid_sprint102_separate_runtime_implementation_final_approval_packet()
    before = json.dumps(p102, sort_keys=True)
    _build(p102)
    assert json.dumps(p102, sort_keys=True) == before


def test_sprint_103_blockers_helper_matches_build_blockers() -> None:
    p102 = _valid_sprint102_separate_runtime_implementation_final_approval_packet()
    bad = dict(p102)
    bad["preview_only"] = False
    assert (
        sprint_103_readiness_packet_blockers_for_tests(bad)
        == _build(bad)["separate_runtime_implementation_readiness_blockers"]
    )
...
def test_module_importable() -> None:
    mod = importlib.import_module(
        "nativeforge.services.active_source_activation_separate_runtime_implementation_readiness_packet_service"
    )
    assert callable(mod.build_active_source_activation_separate_runtime_implementation_readiness_packet)


def test_artifact_type_and_version_constants() -> None:
    assert ARTIFACT_TYPE == "nf_active_source_activation_separate_runtime_implementation_readiness_packet_v1"
    assert ARTIFACT_VERSION == 1


def test_ready_next_gate_is_release_packet() -> None:
    out = _build(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    assert out["next_gate_required"] == NEXT_GATE_SEPARATE_RUNTIME_IMPLEMENTATION_RELEASE_PACKET
...
def test_explicit_output_guard_key_present() -> None:
    out = _build(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    assert EXPLICIT_SPRINT103_OUTPUT_GUARD_KEY in out
    g = out[EXPLICIT_SPRINT103_OUTPUT_GUARD_KEY].lower()
    assert "separate_runtime_implementation_readiness_only" in g


def test_future_activation_execution_plan_execution_allowed_true_on_input_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["future_activation_execution_plan_execution_allowed"] = True
    assert (
        _build(p102)["separate_runtime_implementation_readiness_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    )
...
def test_future_source_activation_allowed_true_on_input_blocks() -> None:
    p102 = dict(_valid_sprint102_separate_runtime_implementation_final_approval_packet())
    p102["future_source_activation_allowed"] = True
    assert (
        _build(p102)["separate_runtime_implementation_readiness_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
    )
...
def test_sprint102_chain_next_gate_before_sprint103() -> None:
    p102 = _valid_sprint102_separate_runtime_implementation_final_approval_packet()
    assert p102["next_gate_required"] == SPRINT102_EXPECTED_NEXT_GATE


def test_sprint102_blocked_packet_does_not_produce_sprint103_ready() -> None:
    ...
    p102 = build_active_source_activation_separate_runtime_implementation_final_approval_packet(
        separate_runtime_implementation_plan_decision_packet_artifact=p101,
    )
    out = _build(p102)
    assert out["separate_runtime_implementation_readiness_status"] == SEPARATE_RUNTIME_IMPLEMENTATION_READINESS_BLOCKED_STATUS
...
def test_ready_status_matches_separate_runtime_implementation_final_approval_approved() -> None:
    p102 = _valid_sprint102_separate_runtime_implementation_final_approval_packet()
    assert (
        p102["separate_runtime_implementation_final_approval_status"]
        == SEPARATE_RUNTIME_IMPLEMENTATION_FINAL_APPROVAL_APPROVED_STATUS
    )
